const PRODUCTS = [
  ...
  },
  {
    ...
    variants: [
      { size: "20mm", price: null },
      { size: "25mm", price: null },
      { size: "32mm", price: 215 },
      { size: "40mm", price: 300 },
      { size: "50mm", price: 460 },
      { size: "63mm", price: 640 },
      { size: "75mm", price: 1050 },
      { size: "90mm", price: 1540 },
    ],
    notes: "",
  ...
  },
  {
    ...
    variants: [
      ...
      { size: "50mm", price: 592 },
      { size: "63mm", price: 925 },
      { size: "75mm", price: 1500 },
      { size: "90mm", price: 2235 },
    ],
    notes: "",
  ...
  },
  {
    ...
    variants: [
      ...
      { size: "32mm", price: 432 },
      { size: "40mm", price: 665 },
      { size: "50mm", price: 1020 },
      { size: "63mm", price: 1585 },
      { size: "75mm", price: 2230 },
      { size: "90mm", price: 3170 },
      { size: "110mm", price: 4725 },
    ],
    notes: "",
      ...
      <div class="detail-view">
        ...
        <div>
          ...
          <div class="variant-section">
            ...
            ${
              manyVariants
                ? `<span class="see-all-toggle" onclick="togglePriceTable()">See full price list ▾</span>
...
function togglePriceTable() {
  ...
  if (t.style.display === "none") {
    ...
    toggle.textContent = "Hide full price list ▴";
  } else {
    t.style.display = "none";
    toggle.textContent = "See full price list ▾";
  }
}
