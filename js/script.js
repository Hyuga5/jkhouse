...
if (hamBtn && navbarEl) {
  hamBtn.addEventListener("click", () => navbarEl.classList.toggle("open"));
  document
    .querySelectorAll('a[href^="#"]')
    .forEach((a) =>
      a.addEventListener("click", () => navbarEl.classList.remove("open")),
    );
}
...
if (csubmitBtn) csubmitBtn.addEventListener("click", cSubmit);
